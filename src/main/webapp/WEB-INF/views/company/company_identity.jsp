...
<body class="p_company_identity">	
	...
	<section>
		<div class="txtarea">
			<h3><spring:message code="label.companyIdentityDesc01" /> <spring:message code="label.myPrivacy" /> </h3>
			<p><spring:message code="label.companyIdentityDesc02" /></p>
		</div>
		<ul>
			<li><img src="/resources/images/company01.jpg" /><p><spring:message code="label.companyIdentityDesc03" /></p></li>
			<li><img src="/resources/images/company02.jpg" /><p><spring:message code="label.companyIdentityDesc04" /></p></li>
			<li><img src="/resources/images/company03.jpg" /><p><spring:message code="label.companyIdentityDesc05" /></p></li>
			<li><img src="/resources/images/company04.jpg" /><p><spring:message code="label.companyIdentityDesc06" /></p></li>
		</ul>
		<p><spring:message code="label.companyIdentityDesc07" /> </p>
		<span><spring:message code="label.companyIdentityDesc08" /></span>
	</section>
	 -->
	<!-- content end -->
	<!-- footer -->
