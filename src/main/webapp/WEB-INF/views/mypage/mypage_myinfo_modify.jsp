...
<body class="p_mypage">	
	...
	<!-- content begin -->
	<ul class="submenu"><li class="active"><a href="./mypage_myinfo.do"><spring:message code="label.myPage" /></a></li><%-- <li><a href="../mypage/mypage_uselist.do"><spring:message code="label.mypageDesc01" /></a></li> --%><li><a href="./mypage_out.do"><spring:message code="label.mypageDesc02" /></a></a></li></ul>
	<section>
