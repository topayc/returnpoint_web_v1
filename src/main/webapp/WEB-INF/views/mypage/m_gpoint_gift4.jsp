...
<div class="modal fade m_point_transfer" id="gpoint_gift4" role="dialog">
		...
		<div class="modal-content">
			...
			<form name="Frm2">
				<div class="modal-body">
					<div class="listmember"><span class="node nd1"><spring:message code="label.magency"/></span>GPoint</div>
					...
					<div class="pointinput">
						...
						<input type="number" placeholder="<spring:message code="label.pointGiftAmount"/>" id="point4" name="point4" onblur="changeAttribute('point4', 1, 'gpoint_gift4');"/>			
