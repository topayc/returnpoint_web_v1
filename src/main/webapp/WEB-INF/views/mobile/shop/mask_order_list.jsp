			...
			<div class="r_basket_box">
				...
				<div class="r_basket_con" data-toggle="collapse" data-target="#order_detail_${status.count}">
					<div class="r_basket_contents">
						...
						<div class="r_basket_contents_text">
							<ul>
								...
								<li style = "font-size : 13px;color : #666">개당가격 : <fmt:formatNumber value="${order.productPrice}" pattern="###,###,###,###" />원 | 색상 : ${order.orderColor}</li>
								<li style = "font-size : 13px;color : #666">구매  :  ${order.orderUnit } 묶음 ${order.orderQty}개 구매</li>
								<li>
										<c:choose>
					...
					<table>
						...
						<tr>
							<td class="r_table1">배송비</td>
							<td class="r_table2">착불 <fmt:formatNumber value="${order.deliveryCharge}" pattern="###,###,###,###" /> 원</td>
