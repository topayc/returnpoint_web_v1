   ...
   <section class="nobtn" id = "main">
	...
	<div style="background-color:#f1f1f1;padding:1px 0;">
		...
		<div class="r_fran_page">
			...
			<div class="r_fran_btn" onclick = "movePage('/m/affiliate/affiliateMain.do?affiliateNo=${model.affiliate.affiliateNo}')" ><img src="/resources/images/r_fran_btn_img.png">${model.affiliate.affiliateName} 가맹점 페이지</div>
			</c:if>
