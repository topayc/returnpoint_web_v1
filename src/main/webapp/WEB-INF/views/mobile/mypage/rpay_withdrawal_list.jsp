			...
			<section>
				<div class="listS01" id = "account_list_frame" style="padding:2%;background-color:#f1f1f1;">
					...
					<c:forEach var="pointWithdrawal"  items="${model.pointWithdrawals}"  >
						<div class="list_li collapsed" style="border:1px solid #ddd;margin-bottom:7px;"data-toggle="collapse" data-target="#point_withdraw_${pointWithdrawal.pointWithdrawalNo}">
