...
<body>
	<div class="r_login">
		...
		<div class="r_login_page3 join_slide">
			<h3>모바일 인증</h3>
			<p>
				<b>R POINT</b> 앱은 핸드폰 번호를 회원님의 아이디로 사용합니다.
			</p>
			<p>아래의 인증 과정을 진행해 주시기 바랍니다.</p>
			<h5>휴대폰 인증</h5>
			<div class="phone_input1">
				<span>KR +82</span> <input type="text" name="휴대폰 번호"
					placeholder="휴대폰번호">
			</div>
		...
		<div class="r_login_page5 join_slide">
			...
			<div class="r_id">
				<p>아이디</p>
				<span>아이디는 인증하신 핸드폰 번호가 설정됩니다.</span> <input type="text" name="아이디"
					placeholder="01012345678">
			</div>
			<div class="r_id">
				<p>비밀번호</p>
				<input type="password" name="비밀번호"
					placeholder="영문+숫자 10자리이상 설정해주세요.">
			</div>
			<div class="r_id">
				<p>비밀번호 확인</p>
	...
	<div class="r_login_page6">
		<div class="r_name">
			<div class="r_name_box">
				...
				<input type="text" name="추천인 전화번호 혹은 이름 입력"
					placeholder="추천인 전화번호 혹은 이름 입력">
